...
export default {
  ...
  description: `With a small team of fellow ENSTA students, we found a database containing electrocardiagrams records and a research paper about heart attacks early detection using <i>t-waves analysis</i>.</br></br>
